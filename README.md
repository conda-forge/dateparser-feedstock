...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dateparser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5554&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dateparser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dateparser` can be installed with:

```
conda install dateparser
```

It is possible to list all of the versions of `dateparser` available on your platform with:
